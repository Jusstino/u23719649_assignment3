...
using PagedList; //Downloaded packages
using PagedList.Mvc; //Downloaded packages
...
namespace u23719649_assignment3.Controllers
{
    public class studentsController : Controller
    {
        ...
        // GET: students
        public async Task<ActionResult> Index(int? page) //recieving page number 
        {
            var result = await db.students.ToListAsync();
            int pageNumber = page ?? 1; //If not defined set to 1
            int pageSize = 15;
